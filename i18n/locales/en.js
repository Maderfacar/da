export default {
  ...
  landing: {
    ...
    book: {
      ...
      to: 'To',
      when: 'When',
      fieldsNote: 'Filled in on the next step',
      fromHint: {
        'airport-pickup': 'Arrival airport and terminal',
        'airport-dropoff': 'Your pickup address',
        charter: 'Your starting point',
      },
      toHint: 'Your destination',
      whenHint: 'Pickup date and time',
