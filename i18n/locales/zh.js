export default {
  ...
  fare: {
    ...
    calc: {
      ...
      field: {
        ...
        dropoffLocationPlaceholder: '搜尋下車地點',
        stopover: '中途停靠站 {n}',
        stopoverPlaceholder: '搜尋停靠地點',
        addStopover: '新增中途停靠站',
        removeStopover: '移除停靠站',
        vehicle: '車型',
        pickup: '上車時間',
        orderType: '行程類型',
        extras: '加值服務（可複選）',
      ...
      error: {
        pickupLocation: '請選擇上車地點',
        dropoffLocation: '請選擇下車地點',
        vehicle: '請選擇車型',
        pickup: '請選擇上車時間',
        fetch: '試算失敗，請稍後再試',
      },
      result: {
        finalNoRounding: '最終車資',
        distanceLabel: '總距離',
        freewayLabel: '國道里程',
        kmUnit: '公里',
        extrasLabel: '加值服務',
      ...
      disclaimer: '試算為估價工具。下單時系統會接上 Google 路徑與即時車程資料重新計算 — 實際金額以下單系統結果為準。',
    },
    notes: {
      label: 'FARE NOTES',
      title: '車資說明',
  ...
  faq: {
    ...
    items: {
      ...
      fareSurcharge: { q: '為什麼有時車資會比一般高？', a: '車資由基本起跳費、里程費與下列加成項目組成，全部明細會在訂車時即時顯示，無隱藏費用：① 山區係數（路線海拔起伏大、彎度高或低速路段時自動套用）；② 跨縣市補貼（跨越縣市時依次數加收）；③ 國道通行費（依國道里程計算）；④ 深夜 / 節慶 / 特定時段加價（依後台時段規則）。所有規則由客服在後台設定，建單時的預估金額已包含上述加成。' },
    ...
    serviceOverview: {
      ...
      title: '服務說明',
      heading: '把您安全送達，是我們唯一的目的地。',
      p1: 'DEST · ANYWHERE 是專注機場與長途接送的派車服務，服務遍及全台。我們相信好的接送不只是把人載到機場，而是讓您在每一段旅程的起點與終點，都能安心、準時、被妥善對待。',
      p2: '從預約完成的那一刻起，到您安全抵達目的地，每一段路都由我們妥善安排。專人專車、全程掌握航班與行程，把接送這件事變得單純。',
    },
    trust: {
      label: 'TRUST & SAFETY',
      title: '安心保障',
      subtitle: '司機與保障',
      tagline: '每一趟行程，都有看不見的把關。',
      item1: '司機須持職業駕駛執照、提供無犯罪紀錄證明（良民證），並通過平台內部二次審查。',
      item2: '全車投保旅客責任險，保額 500 萬元。',
      item3: '接機可加選專人於入境大廳舉牌迎接。',
      item4: '車款皆為合法營業租賃車。',
      item5: '所派遣的車型皆依照車行安排為主。',
    },
    categoriesLabel: 'FAQ',
  },
  // ── 共用 Footer ─────────────────────────────────────────────
  ...
  meta: {
    ...
    // W4 AEO：頁面 h1 描述性文案（語意化 SEO，視覺隱藏但 DOM 存在給爬蟲讀）
    h1: {
      passenger: {
        fare: '車資試算與計費引擎・桃園機場接送收費',
      },
    },
  },
  // ── API 狀態（原有）──────────────────────────────────────
