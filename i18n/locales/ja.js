export default {
  ...
  landing: {
    ...
    book: {
      ...
      to: '到着',
      when: '日時',
      fieldsNote: '次のステップで入力',
      fromHint: {
        'airport-pickup': '到着空港・ターミナル',
        'airport-dropoff': 'お客様の乗車場所',
        charter: 'お客様の出発地',
      },
      toHint: 'お客様の目的地',
      whenHint: 'ご利用日時',
  ...
  home: {
    ...
    nextTrip: {
      ...
      vehicle: '車種',
      passengers: '乗客数',
      emptyTitle: 'まだ旅程はありません',
      emptySub: 'ご予約後、次の旅の時間・車種・ドライバー情報がここに表示されます。',
      emptyCta: '今すぐ予約',
      pickup: '乗車地',
      stopover: '経由地',
      dropoff: '降車地',
  ...
  fare: {
    ...
    vehicle: {
      ...
      title: '車種を選ぶ',
      desc: '人数・荷物・行程に合わせて、スワイプで全車種を見比べて最適な一台をお選びください。',
    ...
    engine: {
      ...
      card2Body: '高低差、カーブの密度、速度、通過する県市、高速道路の距離 — これらをまとめて数式に投入します。山道・越県は、シグナルに応じて自動適用されます。',
